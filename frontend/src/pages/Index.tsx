...
import SearchBox from "@/features/domain/components/SearchBox";
import DomainCard from "@/features/domain/components/DomainCard";
import RecentSearches from "@/features/domain/components/RecentSearches";
import SubscribeModal from "@/features/subscription/components/SubscribeModal";
...
const Index = () => {
  ...
  const handleSearch = async (query: string) => {
    ...
    try {
      const data = await domainService.checkAvailability(query);
